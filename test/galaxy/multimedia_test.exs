defmodule Galaxy.MultimediaTest do
  ...
  describe "videos" do
    test "list_videos/0 returns all videos" do
      owner = user_fixture()  # Create or get a user
      %Video{id: id1} = video_fixture(owner)  # Create a video for the user
      assert [%Video{id: ^id1}] = Multimedia.list_user_videos(owner)  # Pass the user to the function
      %Video{id: id2} = video_fixture(owner)  # Create another video

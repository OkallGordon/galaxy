defmodule Galaxy.Comments do
  ...
  """
  def list_user_comments(%Accounts.User{} = user) do
    Comment
    |> user_comment_query(user)
    |> Repo.all()
  end
  ...
  defp user_comment_query(query, %Accounts.User{id: user_id}) do
